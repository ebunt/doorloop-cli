...
func newLeaseCreditsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "",
		Example:     "  doorloop-pp-cli lease_credits list",
		Annotations: map[string]string{"pp:endpoint": "lease_credits.list", "pp:method": "GET", "pp:path": "/lease-credits", "mcp:read-only": "true"},
