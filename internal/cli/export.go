...
large datasets as it has no memory pressure.`,
  ...
  doorloop-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  doorloop-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  doorloop-pp-cli export <resource> --format jsonl | jq '.id'`,
