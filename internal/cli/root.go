...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "doorloop-pp-cli",
		Short: `Doorloop CLI — Every DoorLoop resource at your fingertips, plus offline delinquency reports, vacancy maps, and cash flow snapshots no …`,
		Long: `Doorloop CLI — Every DoorLoop resource at your fingertips, plus offline delinquency reports, vacancy maps, and cash flow snapshots no …
...
Health check: run 'doorloop-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("doorloop-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'doorloop-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCommunicationLogsCmd(flags))
	rootCmd.AddCommand(newExpensesCmd(flags))
	rootCmd.AddCommand(newFilesCmd(flags))
	rootCmd.AddCommand(newLeaseChargesCmd(flags))
	rootCmd.AddCommand(newLeaseCreditsCmd(flags))
	rootCmd.AddCommand(newLeasePaymentsCmd(flags))
	rootCmd.AddCommand(newLeaseReturnedPaymentsCmd(flags))
	rootCmd.AddCommand(newLeasesCmd(flags))
	rootCmd.AddCommand(newNotesCmd(flags))
	rootCmd.AddCommand(newOwnersCmd(flags))
	rootCmd.AddCommand(newPortfoliosCmd(flags))
	rootCmd.AddCommand(newPropertiesCmd(flags))
	rootCmd.AddCommand(newTasksCmd(flags))
	rootCmd.AddCommand(newTenantsCmd(flags))
	rootCmd.AddCommand(newUnitsCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newVendorBillsCmd(flags))
	rootCmd.AddCommand(newVendorCreditsCmd(flags))
	...
	rootCmd.AddCommand(newDelinquencyCmd(flags))
	rootCmd.AddCommand(newCashflowCmd(flags))
	rootCmd.AddCommand(newLedgerCmd(flags))
	rootCmd.AddCommand(newVacancyCmd(flags))
	rootCmd.AddCommand(newExpiringCmd(flags))
	rootCmd.AddCommand(newPortfolioHealthCmd(flags))
