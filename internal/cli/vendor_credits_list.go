...
func newVendorCreditsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "",
		Example:     "  doorloop-pp-cli vendor_credits list",
		Annotations: map[string]string{"pp:endpoint": "vendor_credits.list", "pp:method": "GET", "pp:path": "/vendor-credits", "mcp:read-only": "true"},
