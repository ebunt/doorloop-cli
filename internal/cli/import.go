...
but do not stop the import.`,
  ...
  doorloop-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  doorloop-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | doorloop-pp-cli import <resource> --input -`,
