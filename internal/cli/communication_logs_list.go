...
func newCommunicationLogsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "",
		Example:     "  doorloop-pp-cli communication_logs list",
		Annotations: map[string]string{"pp:endpoint": "communication_logs.list", "pp:method": "GET", "pp:path": "/communication-logs", "mcp:read-only": "true"},
